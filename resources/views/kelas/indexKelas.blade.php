    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <p style="padding: 4px;margin: 20px;">In this page you can do anything :)</p><span style="font-size: 28px;margin: 24px;">List Kelas</span>
                <div class="btn-group" role="group"></div>
                <div class="container-fluid" style="margin-top: 25px;"><a href="{{ route('kelas.create') }}" <button class="btn btn-primary" type="button" style="margin-bottom: 15px;margin-left: 4px;background: rgb(114,203,42);">Tambah</button></a>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <form action="{{ route('kelas.destroy', $kelas) }}" method="post">
                                            ...
                                            <button class="btn btn-primary" type="submit" style="background: rgb(234, 83, 83);">Delete</button>
                                        </form>
                                    </td>
                                    <td style="text-align: center;">
                                        <form action="{{ route('kelas.edit', $kelas) }}">
                                            @csrf 
                                            <button class="btn btn-primary" type="submit" style="background: rgb(234,210,83);">Edit</button>
                                        </form>
                                    </td>
                                </tr>
                                @endforeach
