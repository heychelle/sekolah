                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                        data-toggle="dropdown" aria-expanded="false" href="#"><button
                            ...
                            <form action="{{ route('murid.update', $murid) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kelas_id" class="custom-select">
                                        ...
                                        {{-- panah pertama mengarah ke function yang ada di murid.php (model), panah kedua menuju kolom yg ada di table --}}
